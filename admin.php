      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#appointmentrequest">Create Request</a></li>
...
<div class="container-fluid">
  <h2 class="sub-header">Appointment Requests</h2>
    ...
    if (mysqli_connect_errno()) {
      ...
      if ($numResults == 0) {
        echo '<div class="col-sm-12">';
          echo "<h4>There are no appoinment requests at this time.</h4>";
        echo "</div>";
      } else {
...
<!-- Create and Edit Appointments --> 
  ...
  <div class="container-fluid appointment"> 
    <h2 id="createheader" class="sub-header">Create New Appointment Request</h2> 
    <h2 id="editheader" class="sub-header">Edit Existing Appointment Request</h2> 
